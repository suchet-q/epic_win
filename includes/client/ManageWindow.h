...
class Managewindow
{
 private:
  ...
  sf::Mutex		*_Mutex;
  Drawer		*_Drawer;
  Pool<Drone, 400>	_DronePool;
  Pool<Alien, 400>	_AlienPool;
  Pool<Dog, 400>		_DogPool;
  Pool<Jumper, 200>	_JumperPool;
  Pool<Xwing, 400>	_XwingPool;
  Pool<Metroid, 400>	_MetroidPool;
  Pool<Larve, 400>	_LarvePool;
  Pool<Fireball, 400>	_FireballPool;
  Pool<Missil, 400>	_MissilPool;
  Pool<Balls, 400>	_BallsPool;
  Pool<Missil2, 400>	_Missil2Pool;
  Pool<Missil3, 400>	_Missil3Pool;
  Pool<Missil4, 400>	_Missil4Pool;
  Pool<Laser, 400>	_LaserPool;
  Pool<Decor1top, 400>	_Decor1TopPool;
  Pool<Decor1down, 400>	_Decor1DownPool;
  Pool<Decor2top, 400>	_Decor2TopPool;
  Pool<Decor2down, 400>	_Decor2DownPool;
  pfObject		*fct;
  pfPool		*fct2;
